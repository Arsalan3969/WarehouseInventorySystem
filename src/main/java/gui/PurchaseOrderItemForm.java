...
public class PurchaseOrderItemForm extends JFrame {

    private JTextField txtItemID;
    private JTextField txtPurchaseOrderID;
    ...
    public PurchaseOrderItemForm() {
        ...
        JLabel heading = new JLabel("Purchase Order Items");
        ...
        txtPurchaseOrderID = new JTextField();
        ...
        addField(formPanel,gbc,1,"Purchase Order ID",txtPurchaseOrderID);
        ...
        itemTable.getSelectionModel().addListSelectionListener(e -> {
            ...
            if (!e.getValueIsAdjusting()) {
                ...
                if (row != -1) {
                    ...
                    txtPurchaseOrderID.setText(tableModel.getValueAt(row,1).toString());
        ...
        btnAdd.addActionListener(e -> {
            ...
            try {
                ...
                item.setPurchaseOrderID(
                        Integer.parseInt(txtPurchaseOrderID.getText())
                );
    ...
    public PurchaseOrderItemForm(int purchaseOrderID) {

        this();

        txtPurchaseOrderID.setText(String.valueOf(purchaseOrderID));
        txtPurchaseOrderID.setEditable(false);

        loadItems(purchaseOrderID);

    }

    private void loadItems(int purchaseOrderID){

        tableModel.setRowCount(0);

        PurchaseOrderItemDAO dao = new PurchaseOrderItemDAO();

        for(PurchaseOrderItem item : dao.getItems(purchaseOrderID)){
